...
/*struct StatoSocketTable
{
    int socketID;
    int stato; //0 deve validare il codice, 1 il codice è validato
};*/
    ...
    while(1){
        ...
        for(i = 0; i <= fdmax ; i++)
        {
            ...
            {                   
                ...
                {
                    printf("\nsock,tipo,nDisp: %d, %c, %d",i, type,nDisp);
